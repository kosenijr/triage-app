            ...
            {patient?.stage === 'triage' &&
                <div>
                    ...
                    <select name="rooms" id="assign-room" onChange={(event) => updateRoomAssignment(patient, event.target.value =)}>
                        <option value="Room 10">--Please choose an option--</option>
                        <option value="Room 10">Room 101</option>
                        <option value="Room 10">Room 102</option>
                        <option value="Room 10">Room 103</option>
