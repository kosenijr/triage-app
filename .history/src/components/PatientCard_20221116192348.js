    ...
    return (
        <div className={styles['patient-card']}>
            <div className={styles['inner-patient-card']}>
                ...
                {patient?.stage === 'treating' && <button className={styles[]} onClick={() => onStartDischarge(patient)}>Start Discharge Process</button>}

                {patient?.stage === 'discharging' && <button className={styles[]} onClick={() => onCompleteDischarge(patient)}>Discharge Process Complete</button>}
