    ...
    return (
        <div className={styles['patient-card']}>
            <div className={styles['inner-patient-card']}>
                ...
                {patient?.stage === 'treating' && <button className={} onClick={() => onStartDischarge(patient)}>Start Discharge Process</button>}

                {patient?.stage === 'discharging' && <button className={} onClick={() => onCompleteDischarge(patient)}>Discharge Process Complete</button>}
