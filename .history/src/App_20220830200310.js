...
function App() {
  ...
  const [treating, setTreating] = useState([{ name: 'Jimmy ', description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt officiis perferendis, non quos veritatis adipisci ut! At ducimus iste quos!' }]);
