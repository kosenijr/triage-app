...
function App() {
  ...
  const [triage, setTriage] = useState([{name: 'John Smith'}]);
  const [treating, setTreating] = useState([{name: 'John Smith'}]);
  const [discharge, setDischarging] = useState([{name: 'John Smith'}]);
