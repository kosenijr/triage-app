  ...
  return (
    <div className={styles['App']}>
      ...
      <div className={styles['right-content']}>
        {isModalOpen && <Modal onCreatePatient={onCreatePatient} setIsModalOpen={setIsModalOpen} />}
        ...
        <div className={styles['patient-content']}>
          <div><span>Number of Patients: </span><span>{numOfPatients}</span></div>

          <div className={styles['processing']}>
            <div className={styles['process-columns']}>
              <div className={styles['triage-header']}>
                <h2>Triage</h2>
                <button className={styles['triage-header-button']} onClick={() => setIsModalOpen(!isModalOpen)}>Create Patient</button>
              </div>
